  ...
  const techeroes = [
    {
      ...
      avatar:
        'https://images.saymedia-content.com/.image/t_share/MTc2NDU3MDE0NzExNjkwNDUz/about-steve-jobs.jpg',
    },
    {
    ...
    return (
      <Flex
        ...
        <Flex
          ...
          <chakra.p className='font-nebula' fontWeight={'bold'} fontSize={20}>
            {name}
            <chakra.span
              fontFamily={'Inter'}
              fontWeight={'medium'}
