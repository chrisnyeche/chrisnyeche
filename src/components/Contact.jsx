...
import { Box, Button, Flex, FormControl, FormLabel, IconButton, Input, InputGroup, InputLeftElement, Link, Stack, Text, Textarea, Tooltip, useClipboard, useColorModeValue, useToast, VStack } from "@chakra-ui/react";
import { BsGithub, BsLinkedin, BsPerson, BsTwitter } from "react-icons/bs";
import { MdEmail, MdOutlineEmail } from "react-icons/md";
import emailjs from "@emailjs/browser";

export default function Contact() {
  const { hasCopied, onCopy } = useClipboard("nyechechris@gmail.com");
  const form = useRef();
  ...
  const sendEmail = (e) => {
    e.preventDefault();
    emailjs.sendForm("service_mxkqxgb", "template_ovc7vdr", form.current, "DKYrXYvmqMVzq5soc").then(
      (result) => {
    ...
    toast({
      title: 'Sucess.',
      description: "Your email have been sent successfully.",
      status: 'success',
      duration: 9000,
      isClosable: true,
    })
      ...
      <Box borderRadius="lg" m={{ base: 5, md: 16, lg: 10 }} p={{ base: 5, lg: 16 }}>
        <Box>
          <VStack spacing={{ base: 4, md: 8, lg: 20 }}>
            <Text as="h3" className="font-cyberpunk" fontSize={{ base: "5xl", lg: "7xl" }}>
              Get in Touch
            </Text>
            ...
            <Stack spacing={{ base: 4, md: 8, lg: 20 }} direction={{ base: "column", md: "row" }}>
              ...
              <Box bg={useColorModeValue("white", "gray.700")} borderRadius="lg" p={8} color={useColorModeValue("gray.700", "whiteAlpha.900")} shadow="base" w={{ base: "300px", md: "500px", lg: "700px" }}>

                {/* Form */}
                <Box spacing={5} as={"form"} ref={form} onSubmit={sendEmail}>
                  ...
                  <FormControl isRequired>
                    ...
                    <InputGroup>
                      ...
                      <Input type="email" name="user_email" id="contactemail" placeholder="Your Email" required />
                    </InputGroup>
                  </FormControl>
                  <FormControl isRequired>
                    <FormLabel>Message</FormLabel>

                    <Textarea name="message" placeholder="Your Message" rows={6} resize="none" required />
                  </FormControl>
                  <Button
                    colorScheme="blue"
                    type="submit"
