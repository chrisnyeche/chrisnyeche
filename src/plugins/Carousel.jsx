    ...
    <Box>
      ...
      <Box>
        <Slider {...settings1} gap={5}>
          ...
          <Box h="250px" w="150px" bg="transparent" p={"3"}>
            <Box backgroundColor={"rgba(112, 71, 235, .15)"} backdropFilter={"blur(5px)"} shadow={"lg"} zIndex={2} w="150px" h="150px" borderRadius={"20px"} padding={"10px"} display={"flex"} alignItems={"center"} justifyContent={"center"}>
              <Image className="animate__animated animate__delay-1s animate__swing animate__infinite	infinite" src={"https://logodownload.org/wp-content/uploads/2022/04/javascript-logo-4.png"} alt={"javascript logo"} w="20" />
            </Box>
          </Box>
          {/* Chakra */}
          <Box h="250px" w="150px" bg="transparent" p={"3"}>
          ...
          <Box h="250px" w="150px" bg="transparent" p={"3"}>
            <Box backgroundColor={"rgba(112, 71, 235, .15)"} backdropFilter={"blur(5px)"} shadow={"lg"} zIndex={2} w="150px" h="150px" borderRadius={"20px"} padding={"10px"} display={"flex"} alignItems={"center"} justifyContent={"center"}>
              <Image className="animate__animated animate__delay-1s animate__zoomInRight animate__infinite	infinite" src={"https://upload.wikimedia.org/wikipedia/commons/thumb/6/62/CSS3_logo.svg/800px-CSS3_logo.svg.png"} alt={"Css logo"} w="20" />
            </Box>
          </Box>
          {/* Html */}
          <Box h="250px" w="150px" bg="transparent" p={"3"}>
