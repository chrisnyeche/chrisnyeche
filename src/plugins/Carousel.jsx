      ...
      <Box>
        <Slider {...settings1} gap={5}>
          ...
          <Box h="250px" w="150px" bg="transparent" p={"3"}>
            <Box backgroundColor={"rgba(112, 71, 235, .15)"} backdropFilter={"blur(5px)"} shadow={"lg"} zIndex={2} w="150px" h="150px" borderRadius={"50%"} padding={"10px"}>
          ...
          {/* Next Js */}
          <Box h="250px" w="150px" bg="transparent" p={"3"}>
            <Box backgroundColor={"rgba(112, 71, 235, .15)"} backdropFilter={"blur(5px)"} shadow={"lg"} zIndex={2} w="150px" h="150px" borderRadius={"50%"} padding={"10px"} display={"flex"} alignItems={"center"} justifyContent={"center"}>
